...
namespace Examenfinalentornos_pablocastrillon.models
{
        ...
        //Clase con atributos
    {
        ...
        public Gato(string raza, string microchip, string nombre, string fechanacimiento, double peso, string comentarios):base(nombre,fechanacimiento,peso,comentarios)
        {
            this.Raza = raza;
